...
Ans Counting Semaphore ทำให้ระบบ ควบคุมจำนวนผู้ใช้งาน resource พร้อมกันได้อัตโนมัติ
ป้องกันการแย่งทรัพยากรเกินจำนวน (resource contention)

2. Load Generator มีผลต่อ Success Rate อย่างไร?
Ans เมื่อระบบมีการโหลดสูง — Counting Semaphore จะช่วยรักษาความเสถียร
แต่ต้องแลกกับ Success Rate ที่ลดลงในช่วง peak load

3. Counting Semaphore จัดการ Resource Pool อย่างไร?
Ans Counting Semaphore = ตัวควบคุมจำนวน resource ที่ใช้พร้อมกันได้ในเวลาเดียวกัน
เป็นกลไกง่ายแต่ทรงพลังสำหรับระบบ Resource Pool เช่น Database, Network หรือ Memory Buffers
