...
Ans ประมาณ 50 ms ให้ประสิทธิภาพดีที่สุด
เพราะมี CPU utilization สูง (~85-90%) และ overhead ต่ำ (~10-15%)ค่า 50 ms จึงเป็นจุดสมดุลระหว่าง “การตอบสนอง” และ “ประสิทธิภาพ CPU”
ในขณะที่ระบบยังตอบสนองได้รวดเร็วพอสำหรับงานหลายประเภท

2. ปัญหาอะไรที่เกิดขึ้นเมื่อ time slice สั้นเกินไป?
Ans ระบบจะ สลับ task บ่อยเกินจำเป็น เกิดการกระตุก  และอาจเห็น LED กะพริบเร็วผิดปกติ
3. ปัญหาอะไรที่เกิดขึ้นเมื่อ time slice ยาวเกินไป?
Ans ระบบจะตอบสนองต่อ event ใหม่ได้ช้า เพราะ task หนึ่ง ครอบครอง CPU นานเกินไป LED แต่ละดวงตอบสนองช้า สลับช้าลง ระบบดูเหมือน “Lag” หรือทำงานแบบไม่เป็นเรียลไทม์
4. Context switching overhead คิดเป็นกี่เปอร์เซ็นต์ของเวลาทั้งหมด?
Ans จากผลการทดลองคาดหวัง:
| Time Slice | Overhead |
|-------------|-----------|
| 10 ms | 25–30% |
| 50 ms | 10–15% |
...
ดังนั้นโดยเฉลี่ย overhead จะอยู่ราว ๆ 10–30% ของเวลาทั้งหมด
ซึ่งหมายถึงในทุก 1 วินาที CPU จะเสียเวลา 0.1–0.3 วินาที ในการเปลี่ยน context

5. งานไหนที่ได้รับผลกระทบมากที่สุดจากการ time-sharing?
Ans Processing task (งานหนัก) ได้รับผลกระทบมากที่สุด
เพราะต้องใช้เวลาต่อเนื่องในการคำนวณ เมื่อถูกแบ่งเวลาออกเป็นช่วงสั้น ๆ
จะต้องเริ่ม–หยุดบ่อย ทำให้ประสิทธิภาพลดลง
ในขณะที่งานเบา ๆ เช่น Sensor หรือ Display task ได้รับผลกระทบน้อยกว่า
