...
Ans Heavy Task ใช้ stack มากที่สุด

2. การใช้ heap แทน stack มีข้อดีอย่างไร?
Ans การใช้ heap ช่วยลดความเสี่ยง Stack Overflow และเหมาะกับงานที่ต้องการหน่วยความจำขนาดใหญ่หรือเปลี่ยนแปลงขณะรัน

3. Stack overflow เกิดขึ้นเมื่อไหร่และทำอย่างไรป้องกัน?
Ans Stack overflow เกิดขึ้นเมื่อ task ใช้หน่วยความจำ stack เกินกว่าที่จองไว้ ใน xTaskCreate()

4. การตั้งค่า stack size ควรพิจารณาจากอะไร?
Ans การตั้ง stack size ต้องอิงกับ ลักษณะงาน, call depth, และ buffer ขนาดใหญ่

5. Recursion ส่งผลต่อ stack usage อย่างไร?
Ans Recursion ใช้ stack มากขึ้นทุกครั้งที่ฟังก์ชันเรียกตัวเอง
เพราะแต่ละ “ระดับการเรียก” จะมี local variables และ return address แยกกัน
