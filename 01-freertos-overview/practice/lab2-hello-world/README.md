...
Ans
- printf() เหมาะกับการแสดงข้อความทั่วไป
- ESP_LOGI() เหมาะกับการ debug หรือ logging จริง เพราะสามารถควบคุมระดับ log ได้จาก menuconfig หรือใน runtime

2. Log level ไหนที่จะแสดงใน default configuration?
Ans ค่า default คือ INFO → แสดงข้อความระดับ E/W/I

3. การใช้ `ESP_ERROR_CHECK()` มีประโยชน์อย่างไร?
Ans ESP_ERROR_CHECK() ช่วย ตรวจจับข้อผิดพลาดอัตโนมัติ และลดการเขียนโค้ดเช็ค error ด้วยตนเอง
เหมาะมากในโปรแกรมที่ต้องการความเสถียร

4. คำสั่งใดในการออกจาก Monitor mode?
Ans Ctrl + ]

5. การตั้งค่า Log level สำหรับ tag เฉพาะทำอย่างไร?
Ans ใช้ฟังก์ชัน esp_log_level_set() เพื่อกำหนด log level สำหรับ tag ที่ต้องการ
